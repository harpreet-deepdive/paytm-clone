...
export const Login = ({
  ...
  onSubmit: (values: { phoneNumber: string; password: string }) => void;
}) => {
  ...
  return (
    <section className="bg-gray-300 h-[100vh] flex items-center justify-center">
      <div className="flex max-w-screen-xl px-4 py-8 mx-auto lg:gap-20 lg:py-16 lg:grid-cols-12">
        <div className="w-full place-self-center lg:col-span-6">
          <div className="p-6 mx-auto rounded-lg shadow bg-white sm:max-w-xl sm:p-8">
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <a
                  href="#"
                  className="w-full inline-flex items-center justify-center py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:ring-4"
                >
                  <svg
